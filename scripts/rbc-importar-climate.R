...
#mudar working directory para pasta onde estao dados climaticos e mascara
exemplo_res = raster("wc2.1_2.5m_bioc_MIROC6_ssp585_2081-2100.tif")
...
camadas = list.files(pattern =".tif", full.names=TRUE)
...
mascara = shapefile("South_America.shp")
...
writeRaster(camadas_res, paste0("~/ascfiles/", paste0("bio",".asc")), driver='ascii', bylayer=TRUE)
